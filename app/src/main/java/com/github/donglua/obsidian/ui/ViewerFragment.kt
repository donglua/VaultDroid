...
class ViewerFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(com.github.donglua.obsidian.R.layout.fragment_viewer, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        activity?.title = path.substringAfterLast("/")

        textView = view.findViewById(com.github.donglua.obsidian.R.id.markdown_view)
    ...
    companion object {
        fun newInstance(path: String): ViewerFragment {
